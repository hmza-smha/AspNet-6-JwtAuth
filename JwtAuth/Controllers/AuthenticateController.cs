...
namespace JwtAuth.Controllers
{
     ...
     * Register and register-admin are almost same, but the register-admin method will be used to create a user with admin role.
     * In login method, we have returned a JWT token after successful login. 
     */
